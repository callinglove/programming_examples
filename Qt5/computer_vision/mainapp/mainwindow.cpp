...
void MainWindow::onPluginActionTriggered(bool)
{
    ...
    if(currentPluginInstance)
    {
        ...
        ui->pluginGroup->setTitle(currentPluginInstance->title());
    }
}
...
//    originalMat = imread(fileName.toStdString());
    originalMat = imread(fileName.toLocal8Bit().toStdString());
//    originalMat = imread("C:/Users/golden/Desktop/guzhuang-古装.jpg");
