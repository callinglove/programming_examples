#ifndef HANDY_OPENCV_TEXT_H
#define HANDY_OPENCV_TEXT_H
...
public:
	...
	*/
	Cv310Text(){}
	Cv310Text(const char *freeType, int font_scale);
	Cv310Text(const char *freeType);
	virtual ~Cv310Text();

	void setPath(const char *freeType);
	...
	*/
    ...
    cv::Size getTextSize(const char *text);
...
private:
    ...
    void updateSize(wchar_t wc, cv::Size& size);
